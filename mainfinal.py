...
with tf.Session() as sess:
    ...
    for epoch in range(epochs):
        ...
        total_d_loss = 0
        KK = 0
        for batch in get_batch(r'D:\Apython\2019012\date', batch_size):
            x_real = batch
            ...
            if KK % 100 == 0:
                print('epoch {}, batch_number={}, tmp_loss_g={}'.format(epoch, KK, tmp_loss_g))
                print('epoch {}, batch_number={}, tmp_loss_d={}'.format(epoch, KK, tmp_loss_d))
    ...
    from IPython import embed; embed()  # if epoch % 50 == 0:
